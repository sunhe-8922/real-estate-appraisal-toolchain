...
# 行6-14: 数据行
row_data = [
    (6,  "成交价格 (元/m²)",      "BLUE",  25000,     "可比实例实际成交单价，需≥3个"),
    (7,  "标准化调整系数",         "BLUE",  1.0,       "财产范围/付款方式/融资条件/税费负担/计价单位统一"),
    (8,  "交易情况修正系数",       "BLUE",  1.0,       "正常交易=1.00; 异常交易据实调整; 范围0.80~1.20 (≤±20%)"),
    (9,  "市场状况调整系数",       "BLUE",  1.0,       "成交日至价值时点价格指数比值; 距价值时点≤2年"),
    (10, "区位状况调整系数",       "BLUE",  1.0,       "位置/交通/配套/环境/楼层/朝向; 范围0.80~1.20"),
    (11, "实物状况调整系数",       "BLUE",  1.0,       "面积/结构/装修/新旧/布局; 范围0.80~1.20"),
    (12, "权益状况调整系数",       "BLUE",  1.0,       "规划/年限/共有/租赁/查封; 范围0.80~1.20"),
]
...
for row, label, style, placeholder, comment_text in row_data:
    ...
    for col_idx in range(2, 6):
        ...
        if style == "BLUE":
            ...
            if isinstance(cell.value, str) and cell.value.startswith("如:"):
                cell.value = None
